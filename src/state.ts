...
import * as battleClientSpec from 'src/snowball-fight/connection/state/client-state-spec'
...
export class GameState{
  ...
  getBattleRoom():Room<battleClientSpec.BattleRoomState>{
    ...
    }else if(this.prevGameRoom && this.prevGameRoom.name == CONFIG.GAME_SNOWBALL_ROOM_NAME){
