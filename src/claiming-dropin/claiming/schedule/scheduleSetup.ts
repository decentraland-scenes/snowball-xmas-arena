...
const sharedCampaignId = ClaimConfig.campaign.PLAY_GAMES.campaign
...
const defaultShow:CampaignDayType = {
  ...
  campaigns:[
    { refId: ClaimConfig.campaign.PLAY_GAMES.refId, campaignId: ClaimConfig.campaign.PLAY_GAMES.campaign, campaignKey: ClaimConfig.campaign.PLAY_GAMES.campaignKeys.key1 },
    { refId: ClaimConfig.campaign.WINNING_TEAM.refId, campaignId: ClaimConfig.campaign.WINNING_TEAM.campaign, campaignKey: ClaimConfig.campaign.WINNING_TEAM.campaignKeys.key1 },
  ]
}
